...
findScriptsDirectory() {
  local dirName=$([[ $rollback = true ]] && echo $1/rollback || echo $1)  
...
populateChangeLog() {
  ...
  <databaseChangeLog
             ...
             xsi:schemaLocation="http://www.liquibase.org/xml/ns/dbchangelog http://www.liquibase.org/xml/ns/dbchangelog/dbchangelog-4.9.0.xsd">
  ' > "${1}"
